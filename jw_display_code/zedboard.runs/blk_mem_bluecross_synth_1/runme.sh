...
HD_PWD='C:/devspace/school/Micronaut/jw_display_code/zedboard.runs/blk_mem_bluecross_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_bluecross.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_bluecross.tcl
